...
namespace ChatBubble
{
    public static class FileIOStreamer
    {
        ...
        public static void FileTimeOutComparator(string directory, int[] entryArray, TimeSpan fileTimeOutSpan)
        {
            ...
            foreach (string file in files)
            {
                ...
                if (!Array.Exists(entryArray, id => "id=" + id.ToString() == fileName))
                {
